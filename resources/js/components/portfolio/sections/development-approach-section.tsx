...
export function DevelopmentApproachSection() {
    return (
        <section className="bg-white py-24 md:py-32 dark:bg-[#060612]">
                        ...
                        >
                            <GlowCard glowColor="violet" className="h-full">
                                <div className="mb-3 flex items-center gap-3">
                                    <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-indigo-500/10 text-sm font-bold text-indigo-600 dark:text-indigo-400">
                                        {String(i + 1).padStart(2, '0')}
                                    </span>
                                    <step.icon className="h-5 w-5 text-slate-400 dark:text-slate-500" />
                                </div>
