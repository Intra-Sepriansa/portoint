        ...
        <>
            <motion.nav
                ...
                className={cn(
                    ...
                    scrolled
                        ? 'border-b border-white/[0.06] bg-[#0a0a1a]/80 backdrop-blur-xl'
                        : 'bg-transparent',
                )}
            >
                <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="hidden items-center gap-2 rounded-lg border border-white/10 bg-white/[0.03] px-3 py-1.5 text-xs text-slate-400 transition-colors hover:border-white/20 hover:text-white md:flex"
                        >
            ...
            <AnimatePresence>
                {mobileOpen && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: -20 }}
                        className="fixed inset-x-0 top-[65px] z-50 border-b border-white/[0.06] bg-[#0a0a1a]/95 backdrop-blur-xl md:hidden"
                    >
