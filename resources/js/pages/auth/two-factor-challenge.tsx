    ...
    const authConfigContent = useMemo<{
        ...
        if (showRecoveryInput) {
            return {
                title: 'Kode recovery',
                description:
                    'Konfirmasi akses ke akun Anda dengan memasukkan salah satu kode recovery darurat.',
        ...
        return {
            ...
            toggleText: 'masuk memakai kode recovery',
        };
    }, [showRecoveryInput]);
                            ...
                            {showRecoveryInput ? (
                                <>
                                    <Input
                                        name="recovery_code"
                                        type="text"
                                        placeholder="Masukkan kode recovery"
